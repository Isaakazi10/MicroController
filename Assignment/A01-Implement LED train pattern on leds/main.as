...
l777:
	movlw	high(0)
	movwf	((c:main@wait+1))^00h,c
	movlw	low(0)
	movwf	((c:main@wait))^00h,c
...
l781:
	infsnz	((c:main@wait))^00h,c
	incf	((c:main@wait+1))^00h,c
	line	20
	
l783:
		movlw	152
	xorwf	((c:main@wait))^00h,c,w
	bnz	u11
	movlw	58
	xorwf	((c:main@wait+1))^00h,c,w
	btfss	status,2
	goto	u11
	goto	u10
...
l811:
	...
	incf	((??_main+1+0))^00h,c
	goto	u114
u115:
	bcf	status,0
	rlcf	((??_main+2+0))^00h,c
u114:
	decfsz	((??_main+1+0))^00h,c
	goto	u115
	movf	((??_main+2+0))^00h,c,w
	iorwf	((c:3969))^0f00h,c,w	;volatile
	movwf	((c:3969))^0f00h,c	;volatile
	goto	l789
	line	38
