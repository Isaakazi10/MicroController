...
?_main:	; 2 bytes @ 0x0
	ds   2
	global	main@i_33
main@i_33:	; 2 bytes @ 0x2
	ds   2
	global	main@i_34
main@i_34:	; 2 bytes @ 0x4
	ds   2
	global	main@i_35
main@i_35:	; 2 bytes @ 0x6
	ds   2
	global	main@i_36
main@i_36:	; 2 bytes @ 0x8
	ds   2
	global	main@i
main@i:	; 2 bytes @ 0xA
	ds   2
...
l781:
	...
	movlw	(01h)&0ffh
	movwf	(??_main+1+0)^00h,c
	incf	(??_main+0+0)^00h,c
	goto	u14
u15:
	bcf	status,0
	rlcf	((??_main+1+0))^00h,c
u14:
	decfsz	(??_main+0+0)^00h,c
	goto	u15
	movf	((??_main+1+0))^00h,c,w
	iorwf	((c:3969))^0f00h,c,w	;volatile
	movwf	((c:3969))^0f00h,c	;volatile
	line	15
	
l783:
	movlw	high(0)
	movwf	((c:main@i_33+1))^00h,c
	movlw	low(0)
	movwf	((c:main@i_33))^00h,c
	
l789:
	infsnz	((c:main@i_33))^00h,c
	incf	((c:main@i_33+1))^00h,c
	
l791:
		movlw	80
	subwf	 ((c:main@i_33))^00h,c,w
	movlw	195
	subwfb	((c:main@i_33+1))^00h,c,w
	btfss	status,0
	goto	u21
	goto	u20
...
l793:
	movlw	high(0)
	movwf	((c:main@i_34+1))^00h,c
	movlw	low(0)
	movwf	((c:main@i_34))^00h,c
	
l799:
	infsnz	((c:main@i_34))^00h,c
	incf	((c:main@i_34+1))^00h,c
	
l801:
		movlw	80
	subwf	 ((c:main@i_34))^00h,c,w
	movlw	195
	subwfb	((c:main@i_34+1))^00h,c,w
	btfss	status,0
	goto	u31
	goto	u30
...
u44:
	...
	movf	((??_main+1+0))^00h,c,w
	xorlw	0ffh
	andwf	((c:3969))^0f00h,c,w	;volatile
	movwf	((c:3969))^0f00h,c	;volatile
	line	12
...
l813:
	movlw	high(0)
	movwf	((c:main@i_35+1))^00h,c
	movlw	low(0)
	movwf	((c:main@i_35))^00h,c
	
l819:
	infsnz	((c:main@i_35))^00h,c
	incf	((c:main@i_35+1))^00h,c
	
l821:
		movlw	80
	subwf	 ((c:main@i_35))^00h,c,w
	movlw	195
	subwfb	((c:main@i_35+1))^00h,c,w
	btfss	status,0
	goto	u71
	goto	u70
...
l823:
	movlw	high(0)
	movwf	((c:main@i_36+1))^00h,c
	movlw	low(0)
	movwf	((c:main@i_36))^00h,c
	
l829:
	infsnz	((c:main@i_36))^00h,c
	incf	((c:main@i_36+1))^00h,c
	
l831:
		movlw	80
	subwf	 ((c:main@i_36))^00h,c,w
	movlw	195
	subwfb	((c:main@i_36+1))^00h,c,w
	btfss	status,0
	goto	u81
	goto	u80
